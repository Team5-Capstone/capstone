...
router.post('/', async (req, res) => {
  try {
    ...
    //  else if (!toEqual1TestPassed && !notToBe2TestPassed && expect1TestPassed && expect2TestPassed) {
    //     res.json('You failed. Check your toEqual and your not.toBe assertions!');
    //   }
    //   else if (!toEqual1TestPassed && !notToBe2TestPassed && !expect1TestPassed && expect2TestPassed) {
    //     res.json('You failed. Check your toEqual, not.toBe assertions and your first expect function!');
    //   }
    //   else if (toEqual1TestPassed && !notToBe2TestPassed && expect1TestPassed && expect2TestPassed) {
    //     res.json('You failed. Check your not.toBe assertion');
    //   }
    //   else if (toEqual1TestPassed && !notToBe2TestPassed && !expect1TestPassed && expect2TestPassed) {
    //     res.json('You failed. Check your toEqual assertion and first expect function');
    //   }
    //   else if (toEqual1TestPassed && !notToBe2TestPassed && !expect1TestPassed && !expect2TestPassed) {
    //     res.json('You failed. Check your toEqual assertion and both expect functions');
    //   }
    //   else if (toEqual1TestPassed && notToBe2TestPassed && !expect1TestPassed && expect2TestPassed) {
    ...
    //   }
    //   else if (!toEqual1TestPassed && notToBe2TestPassed && !expect1TestPassed && expect2TestPassed) {
    //     res.json('You failed. Check your toEqual assertion and your first expect function');
    //   }
    //   else if (!toEqual1TestPassed && notToBe2TestPassed && expect1TestPassed && !expect2TestPassed) {
    //     res.json('You failed. Check your toEqual assertion and your last expect function');
    //   }
    //   else if (toEqual1TestPassed && !notToBe2TestPassed && expect1TestPassed && !expect2TestPassed) {
    //     res.json('You failed. Check your not.toBe assertion and your last expect function');
    //   }
    //   else if (!toEqual1TestPassed && notToBe2TestPassed && !expect1TestPassed && !expect2TestPassed) {
    //     res.json('You failed. Check your toEqual assertion and both expect function');
    //   }
    //   else if (!toEqual1TestPassed && notToBe2TestPassed && expect1TestPassed && expect2TestPassed) {
